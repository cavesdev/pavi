...
static const char no_save_message[] = "Optional. Dont save the processed video.";

static const char json_message[] = "Optional. Save processing results in a json file.";

static const char skip_message[] = "Optional. Number of frames to skip. Default is 1. (no skip)";
...
DEFINE_bool(no_save, false, no_save_message);
DEFINE_bool(json, false, json_message);
DEFINE_int32(skip, 1, skip_message);
...
static void showUsage() {
    ...
    std::cout << "    -no_save                     " << no_save_message << std::endl;
    std::cout << "    -json                        " << json_message << std::endl;
    std::cout << "    -skip                        " << skip_message << std::endl;
}
